...
# SECURITY
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-cwqbk^n)qfj_tjo0aoq17x3mhfqh^^t2nrmlwt4#je3l26so@6')
...
# Use Railway environment variables if available, else fallback to local MySQL
DATABASES = {}
